        ...
        <nav>
            ...
            <div className="center">
                <ul>
                    ...
                    <li>
                        <NavLink to='/controller/assigne' className={({ isActive }) => isActive ? "active" : ""}>Projets Assignés</NavLink>
                    </li>
                    <li>
                    ...
                    <li>
                        <NavLink to='/controller/projet_termine' className={({ isActive }) => isActive ? "active" : ""}>Projets Terminés</NavLink>
                    </li>
                </ul>
            </div>

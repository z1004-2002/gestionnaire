...
export default function ContPro() {
  ...
  const sendMail = () => {
    ...
    fetch("http://localhost:4000/projet/travaux_en_cours?numero="+projet.numero, requestOptions)
      .then(response => response.text())
      .then(result => {
        let a = JSON.parse(result)
        if (a.numero) {
  ...
  useEffect(() => {
    ...
    fetch("http://localhost:4000/projet/3", requestOptions)
      .then(response => response.text())
    ...
    <div className='dashboard'>
      ...
      {modalSend && <div className="modal">
        ...
        <div className="modal-content">
          ...
          <div className="head">
            Commencez les travaux du projet {projet.numero} ?
          </div>
          <div className="btns">
            <span onClick={() => setModalSend(false)}>NON</span>
            <span onClick={() => sendMail()}>OUI</span>
          </div>
        </div>
